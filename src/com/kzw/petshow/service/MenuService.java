...
import com.kzw.petshow.entity.Menu;
...
public class MenuService extends DefaultEntityManager<Menu, Integer> {
	 ...
	 * */
	@Transactional(readOnly=true)
	public List<Menu> listUserMenu(User user) {
	 ...
	 * */
	@Transactional(readOnly=true)
	public List<Menu> listEditorMenu(Editor editor) {
		String roleIds = editor.getRoleId();
		List<Menu> result = new ArrayList<Menu>();
	 ...
	 * */
	@Transactional(readOnly=true)
	public List<Menu> listAdminMenu(Admin admin) {
		String roleIds = admin.getRoleId();
		List<Menu> result = new ArrayList<Menu>();
