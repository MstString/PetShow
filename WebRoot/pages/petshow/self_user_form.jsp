				...
				<div class="widget-body">
					<form class="form-horizontal">
	                    ...
	                    <table class="bs-table">	                     	
	                     	<tr>
	                     		<td width="80">账号：</td>
	                     		<td><input class="form-control" name ="uname" type="text" value="${user.username}"/></td>
	                     	</tr>
	                     	<tr>
	                     		<td width="80">密码：</td>
	                     		<td><input class="form-control" name ="passwd" type="password" value="${user.password}"/></td>
	                     	</tr>	    	                     	
	                     	<tr>
	                     		<td width="80">姓名：</td>
	                     	...
	                     	<tr>
	                     		<td width="80">角色：</td>
	                     		<td>
	                     			<input name="roleName" id="roleName" readonly="readonly" class="form-control" value="${user.roleName}"/>
	                     		</td>
	                     	</tr>
	                     	<tr>
	                     		<td width="70">选择照片</td>
	                     		<td colspan="2"> 
	                     			<input class="form-control" type="hidden" id="head_portrait_path" style="width:78%;display:inline;float:left;" name ="head_portrait_path" type="text" value="${user.head_portrait_path}"/>
	                     			<img id="imgS" width="100" src="${user.head_portrait_path}" style="width:120px;"/>
