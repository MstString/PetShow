...
<div class="am-g ztlb_nr">
		<div class="am-u-sm-12">
			<c:forEach var="pet_shop" items="${list}">
			<div class="ztlb_nr_blockc">
				<div class="ztlb_nr_blockc_l">
					<img src="${pet_shop.shop_picture_path}" alt="">
				</div>
				<div class="ztlb_nr_blockc_r">
					<div class="ztlb_nr_blockc_r_info"></div>
					<a class="ztlb_nr_blockc_r_title">宠物店名称：${pet_shop.shop_name}</a>
					<span class="ztlb_nr_blockc_r_nr">地址：${pet_shop.address}</span>
					<span class="ztlb_nr_blockc_r_nr">电话 ：${pet_shop.phonenum}</span>
				</div>
			</div>
			</c:forEach>
		</div>
