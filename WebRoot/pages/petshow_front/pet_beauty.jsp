...
<div class="am-g ztlb_nr">
		<div class="am-u-sm-12">
			<c:forEach var="pet_beauty" items="${list}">
			<div class="ztlb_nr_blockc">
				<div class="ztlb_nr_blockc_l">
					<img src="${pet_beauty.beauty_picture_path}" alt="">
				</div>
				<div class="ztlb_nr_blockc_r">
					<div class="ztlb_nr_blockc_r_info"></div>
					<a class="ztlb_nr_blockc_r_title">宠物美容院名称：${pet_beauty.beauty_name}</a>
					<span class="ztlb_nr_blockc_r_nr">地址：${pet_beauty.address}</span>
					<span class="ztlb_nr_blockc_r_nr">电话 ：${pet_beauty.phonenum}</span>
				</div>
			</div>
			</c:forEach>
		</div>
