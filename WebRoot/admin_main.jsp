...
<%@page import="com.kzw.petshow.entity.Menu"%>
<%@page import="com.kzw.petshow.entity.Admin"%>
<%
String path = request.getContextPath();
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
Admin currAdmin = (Admin)session.getAttribute("ADMIN");
MenuService menuService = SpringContextHolder.getBean("menuService");
List<Menu> menus = menuService.listAdminMenu(currAdmin);
%>
<!DOCTYPE html>
<html lang="en-us">	
	<head>
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as is --> 
					...
					<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						<img src="${ADMIN.head_portrait_path}" alt="me" class="online" /> 
						<span>
							${ADMIN.realName}
						</span>
					</a> 
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<span class="ribbon-button-alignment">
				    <a href="<%=basePath%>/admin_main.jsp" id="search" class="btn btn-ribbon hidden-xs" data-title="search"><i class="fa fa-grid"></i> 刷新</a>
				</span>
                <!-- end刷新 -->
				<!-- breadcrumb -->
				<ol class="breadcrumb">
