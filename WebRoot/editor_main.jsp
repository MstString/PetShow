...
<%@page import="com.kzw.petshow.entity.Editor"%>

<%
String path = request.getContextPath();
Editor currEditor = (Editor)session.getAttribute("EDITOR");
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
MenuService menuService = SpringContextHolder.getBean("menuService");
List<Menu> menus = menuService.listEditorMenu(currEditor);
%>
<!DOCTYPE html>
<html lang="en-us">	
	<head>
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as is --> 
					...
					<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						<img src="${EDITOR.head_portrait_path}" alt="me" class="online" /> 
						<span>
							${EDITOR.realName}
						</span>
					</a> 
